...
export const metadata: Metadata = {
  ...
  description: 'Bedelli askerlik ücretinin son beş yıldaki dolar, euro, gram altın ve yaklaşık çeyrek altın karşılığını karşılaştır.',
  alternates: { canonical: '/bedelli' },
  openGraph: {
    title: 'Bedelli Askerlik Ücreti ve Karşılaştırma | Devrem',
    description: 'Bedelli askerlik ücretinin 2022–2026 arasındaki alım gücünü EVDS verileriyle karşılaştır.',
    images: [],
  },
      ...
      <Container>
        <div className="bedelli-page-intro">
          ...
          <div className="mt-8 grid gap-7 lg:grid-cols-[1fr_auto] lg:items-end">
            <div className="max-w-4xl"><div className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-3 py-2 text-[10px] font-bold uppercase tracking-[0.1em] text-primary-ink"><BadgeTurkishLira className="size-4" aria-hidden="true" /> Bedelli karşılaştırma merkezi</div><h1 className="mt-4 text-[clamp(2.8rem,6vw,5.2rem)] font-extrabold leading-[0.93] tracking-[-0.075em]">Bedelli ücreti,<br /><span className="text-primary-ink">gerçekte ne kadar?</span></h1><p className="mt-5 max-w-2xl text-base leading-7 text-secondary-foreground">Sadece TL tutarına bakma. 2022’den bugüne beş resmî dönemi dolar, euro ve altın karşılığıyla karşılaştır.</p></div>
