    ...
    <section className="px-4 pb-6 pt-10 sm:px-6 sm:pb-8">
      <Container className="final-cta">
        <div className="relative z-10 max-w-2xl">
          <p className="text-xs font-bold uppercase tracking-[0.14em] text-primary-ink">Devrem topluluğu</p>
          <h2 className="mt-5 text-balance text-4xl font-bold leading-[1.04] tracking-[-0.06em] text-foreground sm:text-5xl lg:text-6xl">Birliğin belli olduysa devrelerin seni bekliyor.</h2>
          <p className="mt-6 max-w-xl text-base leading-7 text-secondary-foreground sm:text-lg">Aynı celp döneminde aynı birliğe gidecek kişilerle askere gitmeden önce tanış.</p>
